...
from qfluentwidgets import Action, RoundMenu, setThemeColor, FluentTranslator, setTheme, Theme, SplitTitleBar, isDarkTheme, SplitPushButton, FluentIcon
...
class LoginWindow(Window, Ui_Form):
    ...
    def __init__(self):
        ...
        self.widget.setStyleSheet("""
            QWidget {
                background-color: #172763; /* Cambia esto al color que prefieras */
